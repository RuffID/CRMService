...
{
    public class CategoryRepository(IGetItemByIdRepository<CompanyCategory, int> getItemById, ICreateItemRepository<CompanyCategory> create,
        IGetItemByPredicateRepository<CompanyCategory> getItemByPredicate) : ICompanyCategoryRepository
    {
        ...
        public void CreateRange(IEnumerable<CompanyCategory> entities) => create.CreateRange(entities);
    }
}
