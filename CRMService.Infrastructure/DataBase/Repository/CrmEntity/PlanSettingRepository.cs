...
namespace CRMService.Infrastructure.DataBase.Repository.CrmEntity
{
    ...
    ) : IPlanSettingRepository
    {
        ...
        public void Create(PlanSetting item)
            => create.Create(item);

        public void CreateRange(IEnumerable<PlanSetting> entities)
            => create.CreateRange(entities);

        public void Delete(PlanSetting item)
            => delete.Delete(item);

        public void DeleteRange(IEnumerable<PlanSetting> entities)
