...
namespace CRMService.Controllers.Entity
{
    ...
    [ApiController]
    public class IssueController(IMapper mapper, IOptions<DatabaseSettings> dbSettings, IOptions<OkdeskSettings> okdSettings, IUnitOfWorkEntities unitOfWork, IssueService service) : Controller
    {
        [HttpGet("list")]
