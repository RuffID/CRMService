...
{
    public class GeneralSettingsRepository(IGetItemByIdRepository<GeneralSettings, Guid> getItemById,
        ICreateItemRepository<GeneralSettings> create,
        IGetItemByPredicateRepository<GeneralSettings> getItemByPredicate,
        IDeleteItemRepository<GeneralSettings> delete) : IGeneralSettingsRepository
    {
        ...
        public void Create(GeneralSettings item) => create.Create(item);

        public void CreateRange(IEnumerable<GeneralSettings> entities) => create.CreateRange(entities);

        public void Delete(GeneralSettings item) => delete.Delete(item);

        public void DeleteRange(IEnumerable<GeneralSettings> entities) => delete.DeleteRange(entities);
    }
}
